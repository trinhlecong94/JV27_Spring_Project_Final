                                            ...
                                            <c:forEach var="orderDetail" items="${order.orderDetails}">
                                                ...
                                                <li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start">
                                                    <div class="product d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start mr-auto">
                                                        ...
                                                        <div><div class="product_image"><img src="${orderDetail.product.images[0].url}" alt=""></div></div>
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <c:forEach var="orderDetail" items="${order.orderDetails}">
                                                        <c:if test="${orderDetail.promotion != null}">
                                                            <li class="list-group-item"><a href="<c:url value="/remove-promotion?id=${orderDetail.promotion.id}"></c:url>">Remove</a>  ${orderDetail.promotion.name}</li>
                                                            </c:if>                                                        
                                                        </c:forEach>                                                    
                                                </ul>
                                            </div>
